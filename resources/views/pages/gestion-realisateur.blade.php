...
<main class="manage-films-content">
    ...
    <div class="manage-films-list">
        ...
        @forelse($realisateurs as $personne)
            <article class="manage-acteur-row">
                ...
                <!-- Action modifier -->
                <a
                    href="{{ route('realisateur.edit', $personne->idPer) }}"
                ...
                <!-- Action supprimer -->
                <form
                    action="{{ route('realisateur.destroy', $personne->idPer) }}" method="POST" class="manage-delete-form">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
